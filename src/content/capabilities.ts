...
/* ════════════════════════════════════════════════════════════════
   ...
   2. CONTENT_PAGES — solution and industry pages. Same shape,
      but prose-led (`lead` + `sections`) instead of feature lists.

   Report pages are NOT here: they are a CMS collection owned by the
   content team (`reports` table, src/views/ReportDetail.tsx). Links to
   them below are plain `reports/<slug>` strings, resolved at render time.
...
/* ════════════════════════════════════════════════════════════════
   2 · Solution pages — the business problem, not the tool
...
/* ════════════════════════════════════════════════════════════════
   3 · Industry pages — load pattern, cost items, the three reports
