    ...
    <main className="min-h-screen grid place-items-center bg-bg px-5 text-center text-ink font-body">
      <div>
        ...
        <div className="mt-7 flex flex-wrap justify-center gap-3">
          <Link href="/" className="inline-flex h-11 items-center rounded-sm bg-primary px-5 font-semibold text-on-primary">صفحه اصلی</Link>
          <Link href="/articles" className="inline-flex h-11 items-center rounded-sm border border-line bg-surface px-5 font-semibold text-steel">مقالات</Link>
        </div>
      </div>
    </main>
  );
